...
/*
 * extends Button, AddBlueFishButton is of type Button
 */
public class AddBlueFishButton extends Button {
	/*
	 * constructor for AddBlueFishButton, creates new Button
	...
	public AddBlueFishButton(float x, float y) {
		// calls the constructor for button with label "Add Blue" at location (x, y)
		super("Add Blue", x, y);
	}
	 ...
	 * if the mouse is over the button, adds a Fish object of type BlueFish to arrayList objects
	 */
